...
mod tests {
    ...
    use qdrant_client::Qdrant;
    use qdrant_client::qdrant::{
        GeoIndexParams, GeoIndexParamsBuilder, IntegerIndexParams, OrderValue, PayloadSchemaInfo,
        PointId, RetrievedPoint, TextIndexParamsBuilder, TokenizerType, order_value, point_id,
    };
